...
class ItemcategoryControllerTest extends WebTestCase
{
    ...
    private string $path = '/itemcategory/';
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'itemcategory[nameitemcategory]' => 'Testing',
        ]);

        self::assertResponseRedirects('/itemcategory/');
    ...
    public function testShow(): void
    {
        ...
        $fixture->setNameitemcategory('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'itemcategory[nameitemcategory]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getNameitemcategory());
    }
